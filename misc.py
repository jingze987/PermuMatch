"""Small inference-only utility subset.

This file keeps only utilities required by MeViS inference and model forward
execution.  Training meters, loss reduction helpers, plotting and checkpoint
saving helpers were removed.
"""
...
def nested_tensor_from_tensor_list(tensor_list: List[Tensor], size_divisibility=1, split=True):
    ...
    if tensor_list[0].ndim != 3:
        raise ValueError("only 3D image tensors are supported")
